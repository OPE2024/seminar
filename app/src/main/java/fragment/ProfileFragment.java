...
import com.onaopemipodimowo.O4Homes.ReadWriteUserDetails;
import com.onaopemipodimowo.O4Homes.UploadProfilePicActivity;
        ...
        referenceProfile.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readUserDetails != null){
                    ...
                    //imageviewer setImageURI() should not be used with regular URI'S. using picasso
